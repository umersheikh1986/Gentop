...
//               <div class="max-w-md mx-auto bg-[#14000b] p-6 rounded-lg shadow-lg">
//                 {/* <!-- Input for USDT --> */}
...
//                   type="number"
//                   id="usdt"
//                   class="mt-2 block  px-2 py-2 border text-[#14000b] w-96 border-gray-300 rounded-md focus:outline-none focus:ring-[#14000b] focus:border-[#14000b]"
...
//                 <select
//                   id="stacking"
//                   class="mt-2 block w-full px-3 py-2 border text-[#14000b] font-bold border-white rounded-md focus:outline-none focus:ring-[#14000b] focus:border-[#14000b]"
//                 >
...
//                 {/* <!-- Approve Button --> */}
//                 <button class="mt-6 w-full bg-white text-[#14000b] font-bold py-2 px-4 rounded-md hover:bg-[#14000b]focus:outline-none focus:ring-2 focus:ring-[#14000b] focus:ring-offset-2">
//                   Approve
//                 </button>

//                 {/* <!-- Buy Button --> */}
//                 <button class="mt-4 w-full  bg-white text-[#14000b] font-bold py-3 px-4 rounded-md hover:bg-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2">
//                   Buy
//                 </button>
//               </div>
//             </div>
...
const usdtAddress = "0x3c7dC48D4E1355Be25951B28EBfD9d36036204E6 "; // Replace with Contract 1 address
const gentopAddress = "0x265B7E04CE2750Bbe7a0AA18c1d2F45908AFe357"; // Replace with Contract 2 address
const stakingContractAddress = "0xea34CA45b3A04c71752d6849534a8A5a850f3a23"; // Replace with Contract 3 address
const preSaleContractAddress = "0x9b1A7D40c0ff887A024c71CAb7f6EdB2D0F50234"; // Replace with Contract 4 address
