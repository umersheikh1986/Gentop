...
const usdtContract = new ethers.Contract(usdtAddress, usdtABI, signer);
      ...
      const amountToApprove =  ethers.utils.parseUnits(usdtAmount.toString(), 0);
...
async function buyTokens() {
  ...
  try {
    ...
    console.log("Approved USDT:", ethers.utils.formatUnits(approvedUSDT,0));
   ...
   const usdtAmountBigInt = ethers.utils.parseUnits(usdtAmount.toString(), 0);
